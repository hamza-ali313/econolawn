                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="images/bannerImg.png" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                                <h1>DISCOVER THE BEAUTY OF YOUR OUTDOORS </h1>
                                <h5>
                                    Revitalize your lawn effortlessly with Econolawn’s top-rated
                                    service. Join the green revolution today!
                                </h5>
                                <a href="" class="btn2">call us today</a>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="images/bannerImg.png" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block d-sm-block">
                                <h1>POWER UP YOUR GARDEN’S CURB APPEAL! </h1>
                                <h5>
                                    Transform your garden’s charm with Econolawn’s expertise! Get started on green
                                    today!
                                </h5>
                                <a href="" class="btn2">call us today</a>
                            </div>
...
<section class="our-process">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h6>our process</h6>
                <h3>EXPLORE THE ECONOLAWN WAY TO GREEN,
                    GORGEOUS GARDENS
                </h3>
            </div>
        </div>
        <div class="row pt-5">
            <div class="col-12 col-lg-3 col-md-6">
                <div class="text-center">
                    ...
                    <p>
                        We chat about your yard dreams, needs, and expectations – setting the stage for success.
                    </p>
                </div>
            </div>
            <div class="col-12 col-lg-3 col-md-6">
                <div class="text-center">
                    ...
                    <p>
                        We then move on to making a tailored plan based on our discussion.
                    </p>
                </div>
            </div>
            <div class="col-12 col-lg-3 col-md-6">
                <div class="text-center">
                    ...
                    <p>
                        Our skilled team brings the plan to life, providing top-notch services for a stunning
                        transformation.
                    </p>
                </div>
            </div>
            <div class="col-12 col-lg-3 col-md-6">
                <div class="text-center">
                    ...
                    <p>
                        Reviewing the results together, making any needed adjustments for your complete satisfaction.
                        Your dream realized.
                    </p>
                </div>
            </div>
        ...
        <div class="row pt-3">
            ...
            <div class="col-12 col-xl-3 col-lg-6 col-md-6 p-0">
                <div class="txt-sec">
                    ...
                    <p>
                        Get crisp, clean lines with Econolawn’s shrub trimming expertise. Create a neat, polished look
                        that
...
<!-- experience slider sec start -->
<section class="experience-slider-sec">
    <div class="container">
        <div class="heading">
            <h3>
            ...
            <div class="col-12">
                <div class="experience-slider">
                    <div class="experience-slide">
                        <p>
                            Solid service from Econolawn. My lawn looks great post-landscaping, and the team was
                            friendly. Just a small hiccup in timing, but overall, good job!
                        </p>
                        <div class="persona">
                            <div>
                                <h4>Henry Fergus</h4>
...
<!-- experience slider sec end -->

<!-- book appointment sec start -->
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6">
                <div class="apt-form">
                    <form action="">
                        <h3>BOOK AN <span>APPOINTMENT</span>
                        </h3>
                        <p>Let’s Work Together For A Beautiful, Well-Kept Outdoor Space!
                        </p>
                        <div class="row">
                            <div class="col-12 col-lg-6">
